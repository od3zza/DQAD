 let loadedImages = [];
    ...
    let cnv;
    let lastGeneratedImage = null; // Armazena a última imagem gerada
    let highResImage = null; // Armazena a versão em alta resolução
    ...
    function windowResized() {
      ...
      // Se há uma imagem gerada, redesenha ela
    ...
    function remixImages() {
      ...
      // Configura o download da versão alta resolução imediatamente
      ...
      setTimeout(() => {
        ...
        // Aplica glitch apenas na versão de exibição
        window.glitchCanvas({
        ...
        .then((glitchedDataURL) => {
          loadImage(glitchedDataURL, (p5img) => {
            ...
            // Salva a versão final com glitch
